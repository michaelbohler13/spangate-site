...
#
#   curl -fsSL https://spangate-site.vercel.app/netmonitor-agent/setup.sh | bash
#
# What this does:
...
echo -e "  ${CYAN}https://spangate.com/netmonitor/settings${RESET}"
echo ""
...
echo -e "${GREEN}╚═══════════════════════════════════════════════════╝${RESET}"
echo ""
echo -e "  Site:      ${BOLD}${SITE_NAME}${RESET}"
echo -e "  Files:     ${BOLD}${SETUP_DIR}${RESET}"
...
echo "    Update image    :  ${_DOCKER} pull ${IMAGE} && cd ${SETUP_DIR} && ${COMPOSE} up -d"
echo ""
